...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.layout_append).setOnClickListener(v -> append.performClick());
        ...
        findViewById(R.id.layout_translate).setOnClickListener(v -> translate.performClick());
